...
use crate::common::ts::{BookTickerData, MarketData, PushTime, TransactionTime};
use prost::Message;
...
impl TransactionTime for PushDataV3ApiWrapper {
    fn transaction_time(&self) -> i64 {
        ...
        self.create_time
            .unwrap_or_else(|| self.send_time.unwrap_or(0))
    }
}
...
impl PushDataV3ApiWrapper {
    ...
    pub fn extract_latest_book_ticker_data(&self) -> Option<&PublicBookTickerV3Api> {
        match &self.body {
            Some(push_data_v3_api_wrapper::Body::PublicBookTicker(ticker)) => Some(ticker),
            _ => None,
        }
    }
    /// 提取深度数据
    ...
    pub fn get_message_type(&self) -> &str {
        match &self.body {
            ...
            Some(push_data_v3_api_wrapper::Body::PublicBookTickerBatch(_)) => {
                "PublicBookTickerBatch"
            }
            Some(push_data_v3_api_wrapper::Body::PublicIncreaseDepthsBatch(_)) => {
            ...
            Some(push_data_v3_api_wrapper::Body::PublicAggreBookTicker(_)) => {
